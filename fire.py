...
# === VIDEO MODE ===
    ...
    if uploaded_video:
        ...
        if action == "Run Detection":
            # Checkbox to confirm processing
            process_video = st.checkbox("Process video and enable download")
            ...
            if process_video:
                ...
                st.info("Please check the box above to process the video and enable download.")
